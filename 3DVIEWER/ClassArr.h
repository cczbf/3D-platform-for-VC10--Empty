...
//##ModelId=40E265440146
template<class TYPE, class ARG_TYPE>
class CClassArray
{
public:
// Construction & destruction
	//##ModelId=40E26544015F
	CClassArray()									{ m_pData = NULL; m_nSize = m_nMaxSize = m_nGrowBy = 0; }
	~CClassArray();

// Attributes
	//##ModelId=40E26544015E
	int GetSize() const								{ return m_nSize; }
	//##ModelId=40E26544015D
...
protected:
	...
	//##ModelId=40E26544014C
	TYPE* m_pData;   // the actual array of data
	//##ModelId=40E26544014B
	int m_nSize;     // # of elements (upperBound - 1)
	//##ModelId=40E26544014A
	int m_nMaxSize;  // max allocated
	//##ModelId=40E265440149
