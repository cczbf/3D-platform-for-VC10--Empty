...
public:
	...
	void SymmTri(triEDGE &triEdge1, triEDGE &triEdge2) 
	{
	...
	/* Get or set the attributive of a triangle                                 */
...
private:
	...
	CMemoryPool <EDGE, EDGE &>				m_badSegments;
...
public:
	void BeginAddTriangles();
	void AddTriangle(TRIANGLE* tri);
	void initializeshellepool();
	SHELLE* AddShelle(triPOINT* p1,triPOINT* p2);
	void BeginAddShelle();
