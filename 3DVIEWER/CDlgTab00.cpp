	...
	: CScrollDlg(CDlgTab00::IDD, pParent)
{
	...
	//this->m_cstrFName="Monkey";
	strcpy( (LPSTR)(this->m_strFName), "Monkey");

//	this->m_cstrFName.Format("%s","MOnkey");
	g_CGlobals.m_pDlgTab00 = this;

	this->m_Monkey =654321;
}
...
//		m_cstrFName = cstrFName;
		strcpy_s(m_strFName, cstrFName);
		this->m_Monkey =123456;
		CMy3dViewerDoc* pDoc = g_CGlobals.get_m_pCBmpviewerDoc();
