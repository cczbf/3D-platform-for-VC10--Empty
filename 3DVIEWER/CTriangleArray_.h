...
#ifndef CTriangleArray_h_
#define CTriangleArray_h_ 1
...
class CTriangleArray_ : public CArray< CTriangle_,CTriangle_ >  //## Inherits: <unnamed>%3FCA951A02C5
{
